...
def list_folders(service, folder_id):
    ...
    dff = dff[(dff["modifiedTime"] >= f"2025-10-01")]#{str(fecha_actual)}
    #dff = dff[~dff["name"].str.contains("ABG|GAP|GMH", case=False, na=False)]
    dff = dff[dff["name"].str.contains("GAP037", case=False, na=False)]#
