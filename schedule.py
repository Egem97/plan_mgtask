...
async def main():
    ...
    scheduler.add_job(load_biometria_2026, hour='7-20', minute='28,55', timezone='America/Lima')
    scheduler.add_job(load_biometria_experimental_2026, hour='7-20', minute='28,55', timezone='America/Lima')
