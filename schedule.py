...
async def main():
    ...
    scheduler.add_job(load_kissflow_fertirriego, 'cron', hour='8-20', minute='15,45', timezone='America/Lima')
    ...
    scheduler.add_job(proy_2026_load_data, 'interval', minutes=10)
